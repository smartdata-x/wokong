...
#hdfs dfs -put ./target/spark_kafka-1.0-SNAPSHOT.jar /user/wukun/jars/
 ...
 spark-submit \
  --class com.kunyan.wokongsvc.realtimedata.SparkFollow  \
  ...
  ./target/spark_kafka-1.0-SNAPSHOT.jar /home/wukun/work/Wokong/log4j.properties ./config.xml /home/wukun/work/Wokong/src/main/scala/com/kunyan/wokongsvc/realtimedata/userStatic.txt /home/wukun/work/Wokong/src/main/scala/com/kunyan/wokongsvc/realtimedata/stockStatic.txt 1 
