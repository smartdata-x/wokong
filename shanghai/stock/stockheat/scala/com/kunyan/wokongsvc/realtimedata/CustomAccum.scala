 ...
 *
  ...
  implicit object HashMapAccumulatorParam extends AccumulatorParam[mutable.HashMap[String, Int]] {
 ...
 *
      ...
      */
    def addInPlace(
                    t1: mutable.HashMap[String, Int],
                    t2: mutable.HashMap[String, Int]
 ...
 *
      ...
      * @author wukun
      */
    def zero(initialValue: mutable.HashMap[String, Int]): mutable.HashMap[String, Int] = initialValue
  }
