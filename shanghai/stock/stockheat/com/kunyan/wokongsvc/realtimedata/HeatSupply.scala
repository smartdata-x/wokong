...
# Filename : /home/wukun/work/BackCheck/src/main/scala/com/kunyan/backckeck/HeatStatstic.scala
# Author   : Sunsolo
# Email    : wukun@kunyan-inc.com
# Date     : 2016-08-17 15:56
=============================================================================*/

import com.kunyan.wokongsvc.realtimedata.DataPattern.Tuple2Map
import com.kunyan.wokongsvc.realtimedata.{TimeHandle, MixTool, MysqlHandle, XmlHandle}
...
object HeatSupply {
  ...
  def main(args: Array[String]) {
    ...
    while({
      ...
      val staticData = stc.textFile(dataPath + file + ".tar.gz")
      .map( x => {
