...
object FollowMainApp {
  ...
  def flatMapFun(timeStam:String,stockCodesTemp:Set[String]): mutable.MutableList[String] = {
    ...
    /** visit */
    if (!stockCodesTemp.isEmpty  &&  timeStamp != null) {
